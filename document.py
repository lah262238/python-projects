...
# Title
title = doc.add_heading('Methodology Approaches for Preparing and Standardizing Gecko Homogenate: '
                                 'A Comprehensive Review (2020 to 2026)', 0)
...
# Keywords
doc.add_paragraph('Keywords:', bold=True)
...
doc.add_paragraph(
    ...
    'Southeast Asia [web:25]. Its dry body has been used as an anti-asthmatic agent for two thousand years in traditional '
    'Chinese medicine (TCM), widely incorporated into Chinese patent medicines such as Gejie Dingchuan capsule and pill [web:25]. '
    'Despite increasing medicinal demand, ecological deterioration, and excessive hunting, G. gecko has been listed as a Class II '
    'protected species in China since 1989 [web:25].'
)
...
doc.add_paragraph(
    ...
    'preparation of tissue homogenate is essential [web:5]. The homogenate, after centrifugation, yields supernatant (clear solution) '
    'and sediment (membrane-bound portion), both used for various estimations [web:5]. However, specific methodology for gecko tissue '
...
doc.add_paragraph(
    ...
    'high-quality homogenates and ensuring reliable, reproducible results in gecko biochemical research [web:9].'
)
...
doc.add_paragraph(
    'The dry body of Gekko gecko exerts remarkable effects on strengthening the immune system and treating tumors [web:25]. '
    'Over the past decades, increasing medicinal demand has led to population declines of up to 50% in some locations [web:17]. '
...
doc.add_paragraph(
    ...
    'circular consensus reads and 203,994 high-quality isoforms [web:25]. This genetic resource accelerates transcriptome research '
    'and lays foundation for further research on gene function and biological regulatory mechanisms in G. gecko [web:25].'
)
...
doc.add_paragraph(
    ...
    'populations, revealing that TCM tokays are likely not of local Hong Kong origin but imported from Southeast Asia [web:17]. '
)
...
doc.add_paragraph(
    'Proper sample handling and storage are essential to maintain sample integrity before homogenization [web:9]. For cultured adult '
    'Tokay gecko samples, specimens are housed with 12:12 day-night light cycle and 70% humidity, fed ad libitum access to water '
    'and ground beetles (Eupolyphaga sinensis Walker) daily prior to euthanasia [web:25].'
)

doc.add_paragraph(
    'Tissues including heart, kidney, liver, lung, skin, blood, muscle, stomach, ovary, and oviduct are dissected, immediately '
    'frozen in liquid nitrogen, and stored at −80°C [web:25]. For wild-caught specimens, tail clippings (~0.5 cm) are collected, '
    'with half stored in 70% ethanol for genetic study and half in empty tubes for stable isotope analysis [web:17].'
)
...
doc.add_paragraph(
    ...
    'the surface [web:31]. The tissue block is then weighed, with the mass to volume ratio of tissue to PBS recommended to be 1:9 '
    '(i.e., 100 mg sample added to 900 μl PBS) [web:31]. Tissue sampling volume should be more than 30 mg at minimum to avoid too '
    'little homogenization buffer affecting grinding effect [web:31].'
)

doc.add_heading('3.3 Tissue Cutting', level=2)
doc.add_paragraph(
    'The weighed tissue should be cut into as small pieces as possible to fully homogenate [web:31]. This step ensures better '
...
doc.add_paragraph(
    'Various methods and techniques for tissue homogenization offer researchers a range of options to suit specific needs [web:9]. '
...
doc.add_paragraph(
    ...
    'effort and may not be suitable for larger sample sizes [web:9]. It is commonly used for soft tissues or when gentle disruption '
    'is desired.'
)

doc.add_paragraph('4.1.2 High-Speed Blenders')
doc.add_paragraph(
    'High-speed blenders mechanically disrupt tissues quickly and effectively, suitable for a wide range of tissue types [web:9]. '
...
doc.add_paragraph(
    ...
    'speed is slowly increased [web:5]. If speed is increased immediately, there are chances of apparatus breakdown [web:5].'
)

doc.add_paragraph('4.1.4 TissueLyser with Stainless Steel Beads')
doc.add_paragraph(
    'Tissues are weighed in 2 mL microcentrifuge tubes, and 500 μL of Cell Lysis Buffer is added per 100 mg tissue [web:23]. '
    'One 5-mm stainless steel bead is added, and tubes are assembled into TissueLyser. Homogenization occurs at 25 Hz for 0.5–3 '
    'minutes [web:23]. This method offers high throughput and efficient disruption.'
)

doc.add_heading('4.2 Bead Mill Methods', level=2)
doc.add_paragraph(
    'Tissues are mixed with small beads and subjected to mechanical agitation [web:9]. Bead mills offer high throughput and '
...
doc.add_paragraph(
    'Ultrasonic waves are applied to tissues, causing mechanical disruption through cavitation [web:9]. This method is non-contact '
...
doc.add_paragraph(
    ...
    'crushing to prevent temperature increase [web:31]. Probe sonication can be used with burst sonication (5 seconds at 30% power) '
    'to generate fine protein powder [web:32].'
)

doc.add_heading('4.4 High-Pressure Methods', level=2)
doc.add_paragraph(
    'Tissues are subjected to high pressure through narrow gap using piston-driven apparatus [web:9]. This technique efficiently '
...
doc.add_paragraph(
    ...
    'large-scale applications, commonly used for plant tissues and microbial cells [web:9].'
)
...
doc.add_paragraph(
    ...
    'delicate molecules [web:9]. This method is particularly suitable for heat-sensitive samples.'
)
...
doc.add_paragraph(
    ...
    '[web:9]. This method allows isolation of specific cell populations, frequently employed in cell culture experiments.'
)

doc.add_paragraph(
    'Detergents such as Triton X-100 or NP-40 disrupt cell membranes and solubilize cellular components [web:9]. Useful for '
...
doc.add_paragraph(
    'Temperature control during homogenization is critical to preserve delicate molecules and prevent heat-induced damage [web:9]. '
...
doc.add_paragraph(
    'Homogenization can develop friction which increases solution temperature [web:5]. The tissue block should be moved into glass '
    'homogenizer with corresponding volume of PBS for full grinding, and process should be carried out on ice [web:31].'
)

doc.add_paragraph(
    'For TRIzol tissue homogenate, sample should be kept at 4°C (on ice) during protocol unless otherwise stated [web:32]. Incubation '
    'occurs on ice/at 4°C for 30 minutes with mixing, then 5 minutes at 30°C before cooling on ice [web:32].'
)
...
doc.add_paragraph(
    'The choice of buffer, pH, and osmolality should be optimized to maintain cellular stability and prevent degradation [web:9].'
)

doc.add_heading('6.1 Phosphate Buffer Solutions', level=2)
doc.add_paragraph(
    'PBS (0.01 mol/L, pH 7.0–7.4) is commonly recommended for tissue homogenization [web:31]. Tissue homogenates, typically from 0.2 '
    'g tissue, are prepared in phosphate buffer (PBE) by Ultra-Turrax homogenizer (~10 s) in ice-cooled plastic tubes [web:33].'
)

doc.add_heading('6.2 Cell Lysis Buffer', level=2)
doc.add_paragraph(
    'Cell Lysis Buffer (EPX-99999-000) is used with 500 μL added per 100 mg tissue for TissueLyser homogenization [web:23]. This '
...
doc.add_paragraph(
    ...
    '[web:16]. This is used for Salmonella isolation and processing.'
)

doc.add_heading('6.4 TRIzol Reagent', level=2)
doc.add_paragraph(
    'TRIzol reagent allows simultaneous RNA and protein extraction. Add 1 mL ice-cold TRIzol per 0.1 g tissue weight [web:32]. This '
...
doc.add_paragraph(
    'Once solution is formed, stop homogenization process and centrifuge [web:5]. The homogenate after centrifugation gives supernatant '
    '(clear solution) and sediment (membrane-bound portion) [web:5].'
)

doc.add_heading('7.1 Standard Centrifugation Conditions', level=2)
doc.add_paragraph(
    'The prepared homogenate is centrifuged at 5,000 × g for 5 minutes, and supernatant is taken for detection [web:31]. This is '
    'suitable for ELISA detection and general biochemical analysis.'
)

doc.add_heading('7.2 High-Speed Centrifugation', level=2)
doc.add_paragraph(
    'For tissue homogenate preparation for ProcartaPlex protocol, centrifuge sample at 16,000 × g for 10 minutes at 4°C [web:23]. '
...
doc.add_paragraph(
    ...
    'TRIzol lysate forms supernatant [web:32]. For phase separation, centrifuge at 12,000 rcf × 5 min.'
)

doc.add_heading('7.4 Fat Removal', level=2)
doc.add_paragraph(
    'Since most tissue samples contain fat, if supernatant is cloudy after homogenization, store at 4°C appropriately [web:31]. '
...
doc.add_paragraph(
    ...
    'ELISA experiments are divided by corresponding BCA results to obtain amount of target material per mg total protein [web:31].'
)
...
doc.add_paragraph(
    ...
    '[web:23][web:32]. Protein concentration should be between 2.5 and 7.5 mg/mL [web:32].'
)

doc.add_heading('8.2 Sample Dilution', level=2)
doc.add_paragraph(
    'Dilute samples to 10 mg protein/mL with 1× PBS for ProcartaPlex protocol [web:23]. 1:9 ground tissue homogenate samples generally '
    'need dilution for ELISA detection; optimal dilution ratio determined based on pre-experiments [web:31].'
)

doc.add_heading('8.3 Normalization', level=2)
doc.add_paragraph(
    'Normalize protein content and follow standard in-solution digestion protocol [web:32]. Add 200 μL 0.25% Rapigest in 50 mM ammonium '
    'bicarbonate and resolubilize pellet with vortex and heat to 60°C [web:32].'
)
...
doc.add_paragraph(
    ...
    'superiority to classical or tissue-specific methods [web:35]. This approach may be applicable to gecko tissue homogenates.'
)
...
doc.add_paragraph(
    ...
    'cellular structures [web:9]. homogenate should be even consistency with no visible chunks [web:32].'
)

doc.add_heading('9.2 Sample Integrity Assessment', level=2)
doc.add_paragraph(
    'RNA integrity and concentration assessed using Agilent Bioanalyzer 2100 system and Qubit 2.0 Fluorometer [web:25]. High-quality '
...
doc.add_paragraph(
    ...
    '[web:9]. The choice of homogenization method should be based on tissue type, sample size, desired degree of disruption, and '
    'downstream applications [web:9].'
)
...
doc.add_paragraph(
    ...
    'overheating sample during homogenization [web:2]. Homogenization should take place under fume hood to reduce exposure to small '
    'particles [web:6].'
)
...
header[1].text = 'Recommended Value/Condition'
header[2].text = 'Reference'
...
doc.add_paragraph(
    ...
    '[web:5]. Both supernatant and sediment are used for various estimations including enzyme activity measurements.'
)

doc.add_heading('11.2 Proteomic Analysis', level=2)
doc.add_paragraph(
    'Tissue homogenate preparation for proteomics analyses requires standardized extraction and homogenization protocols [web:28]. '
    'SMRT sequencing of G. gecko full-length transcriptome identified 111,372 transcripts annotated against eight databases, '
    'providing genetic resource for proteomic research [web:25].'
)

doc.add_heading('11.3 Enzymatic Analysis', level=2)
doc.add_paragraph(
    'Black-spotted geckos affect immune regulation in mouse models of asthma [web:25]. Enzyme activity detection requires chilled '
    'environment during homogenization to prevent enzyme destruct ion [web:5].'
)

doc.add_heading('11.4 Microbiological Analysis', level=2)
doc.add_paragraph(
    'For Salmonella isolation from gecko lower gut, tissues are homogenized in buffered peptone water [web:16]. Lower gut of each '
...
doc.add_paragraph(
    ...
    'kits [web:17]. Stable isotope analysis uses tail tissue tip dried at 60°C for 24 hours minimum [web:17].'
)
...
doc.add_paragraph(
    'Tokay geckos are second largest gecko species, widespread across Asia [web:17]. Two morphs (black- and red-spotted) or subspecies '
    '(G. gecko reevesii and G. gecko gecko) exist, sometimes elevated to species level [web:17]. Different tissues may require '
    'optimized homogenization conditions.'
)

doc.add_heading('12.2 Sample Availability', level=2)
doc.add_paragraph(
    'G. gecko is rare and endangered medicinal animal in China [web:25]. Listed as Class II protected species since 1989 [web:25]. '
...
doc.add_paragraph(
    'Choice of bead material, size, and agitation speed must be optimized for specific applications [web:9]. Detergent concentration '
    'must be optimized to avoid interference with downstream analyses [web:9]. Optimal dilution ratio for ELISA determined based on '
    'pre-experiments [web:31].'
)

doc.add_heading('12.4 Temperature Sensitivity', level=2)
doc.add_paragraph(
    'Temperature increase destructs enzyme activity [web:5]. Homogenization friction increases solution temperature [web:5].Temperature '
    'control crucial to prevent heat-induced damage [web:9].'
)
...
doc.add_paragraph(
    'Integration of homogenate preparation with full-length transcriptome data from SMRT sequencing [web:25] could accelerate gene '
...
doc.add_paragraph(
    'Given endangered status of G. gecko [web:25], development of micro-scale homogenization techniques requiring minimal tissue '
...
doc.add_paragraph('• Tissue-to-buffer ratio of 1:9 (100 mg:900 μL PBS) is standard for most applications [web:31]')
doc.add_paragraph('• Temperature control on ice at 4°C is critical to preserve enzyme activity and prevent protein denaturation [web:5][web:31]')
doc.add_paragraph('• PBS pH 7.0–7.4 maintains cellular stability [web:31]')
doc.add_paragraph('• Centrifugation at 5,000 × g for 5 min (standard) or 16,000 × g for 10 min at 4°C (high-speed) yields clear supernatant [web:23][web:31]')
doc.add_paragraph('• Protein concentration should be normalized to 2.5–7.5 mg/mL for most analyses [web:32]')
doc.add_paragraph('• Various homogenization methods (mechanical, bead mill, ultrasonic, cryogenic) offer options based on tissue type and downstream application [web:9]')
doc.add_paragraph('• Validation of homogenization efficiency through target molecule release assessment ensures reproducibility [web:9]')
...
for ref_id, ref_text in references:
    doc.add_paragraph(ref_text, style=' citation')
